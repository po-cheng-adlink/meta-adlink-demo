...
class DatafsPlugin(SourcePlugin):
    ...
    def do_prepare_partition(cls, part, source_params, cr, cr_workdir,
        ...
        # Note: We only care about TARGET_DOCKER_PARTITION_IMAGE (from docker-disk.inc)
        #       or any other WIC_DATA_PARTITION_IMAGE that we want to write to the additional data partition
        #       which is used in wic/image-rootfs-data.wks.in
