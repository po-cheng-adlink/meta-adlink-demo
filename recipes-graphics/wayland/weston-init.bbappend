...
WESTONPASSWD = "\$5\$z6JPxtaQ.\$zbGKf9iOibT7FvMris43CBrzehww.Mg4UBbjGXCO7F0"
USERADD_PARAM:${PN} = "--home /home/weston --shell /bin/sh --user-group -G video,input,render,wayland,root,sudo,dialout,tty,disk -p '${WESTONPASSWD}' weston"
